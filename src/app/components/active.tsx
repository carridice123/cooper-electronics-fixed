...

{
  ...
  <section className={styles.cardiscription}>
    <div className={styles.discriptiondiv}>
      <p>
        This Honda (name) year 2006 was modified into a button push to start
        vehicle
      </p>
      <p>
        We also installed a high based music stereo systems for you and design
        it to also work with your phone wirelessly.
      </p>
    </div>
    ...
    <p className={styles.detailspanp1}>
      If you want to host an event like a birthday party and dont want to go
      over board.
    </p>
    <p className={styles.detailspanp1}>
